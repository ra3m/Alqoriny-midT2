...
public class DatabaseHelper extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "users.db"; public static final String TABLE_NAME = "users_data"; public static final String COL1 = "ID";
    public static final String COL2 = "PRODUCT_NAME"; public static final String COL3 = "PRODUCT_QUANTITY";
    /* Constructor */
    ...
    public void onCreate(SQLiteDatabase db) {
        String createTable = "CREATE TABLE " + TABLE_NAME +
                ...
                " PRODUCT_NAME TEXT, PRODUCT_QUANTITY TEXT)"; db.execSQL(createTable);
    }
    ...
    */
    public boolean addData(String productName, String productQuantity) { SQLiteDatabase db = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues(); contentValues.put(COL2, productName);
    ...
    //TODO: Students need to try to fix this public Cursor getSpecificResult(String id){
    SQLiteDatabase db = this.getReadableDatabase();
    Cursor data = db.rawQuery("SELECT * FROM " + TABLE_NAME+ " WHERE ID = ?", new
            String[]{id});
        if (data != null){
                data.moveToFirst();
                return data;
